...
import { BADGES, COMPREHENSIVE_THEORIES } from '../constants';
import { 
        ...
        <div className="relative z-10 mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
            <div className="flex items-center gap-2 text-emerald-300 text-xs font-medium mb-1">
              <Sparkles size={14} /> Overall Mastery
            </div>
            <p className="text-2xl sm:text-3xl font-black text-white">{overallMastery}%</p>
          </div>
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
            <div className="flex items-center gap-2 text-emerald-300 text-xs font-medium mb-1">
              <BookOpen size={14} /> Theories Read
            </div>
            <p className="text-2xl sm:text-3xl font-black text-white">{completedTheoriesCount} / {totalTheories}</p>
          </div>
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
            <div className="flex items-center gap-2 text-emerald-300 text-xs font-medium mb-1">
              <CheckCircle2 size={14} /> Avg Quiz Score
            </div>
            <p className="text-2xl sm:text-3xl font-black text-white">{avgQuizScore}%</p>
          </div>
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
            <div className="flex items-center gap-2 text-emerald-300 text-xs font-medium mb-1">
              <Flame size={14} className="text-amber-400" /> Study Streak
            </div>
            <p className="text-2xl sm:text-3xl font-black text-white">{progress.studyStreakDays} Days</p>
          </div>
        </div>
      </div>
            ...
            <div className="p-8 sm:p-12 border-4 border-emerald-900/20 rounded-2xl bg-gradient-to-b from-emerald-50/20 via-white to-emerald-50/30 text-center relative overflow-hidden">
              ...
              <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-6">
                <div className="text-left">
                  ...
                  <p className="text-xs text-slate-500">Associate Professor in Health Education</p>
                  <p className="text-[10px] text-emerald-700">@healthcono • healcono@gmail.com</p>
                </div>
